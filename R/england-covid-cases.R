...
latest.date = max(vaccinations.England.ages$date)
vaccinations.England.ages.latest <- subset(vaccinations.England.ages, vaccinations.England.ages$date == latest.date)

## Delete unnecessary columns

vaccinations.England.ages.latest <- vaccinations.England.ages.latest[-c(6,8,10,12,12:16)]

## First dose only 

vaccinations.England.ages.latest$FirstDoseOnly <- vaccinations.England.ages.latest$cumPeopleVaccinatedFirstDoseByVaccinationDate - vaccinations.England.ages.latest$cumPeopleVaccinatedSecondDoseByVaccinationDate 

# No vaccine 

vaccinations.England.ages.latest$NoVaccine <- vaccinations.England.ages.latest$VaccineRegisterPopulationByVaccinationDate - vaccinations.England.ages.latest$cumPeopleVaccinatedFirstDoseByVaccinationDate

# Second dose only

vaccinations.England.ages.latest$SecondDoseOnly <- vaccinations.England.ages.latest$cumPeopleVaccinatedSecondDoseByVaccinationDate - vaccinations.England.ages.latest$cumPeopleVaccinatedThirdInjectionByVaccinationDate
...
# 12 to 15
vaccinations.12to15 <- subset(vaccinations.England.ages.latest, vaccinations.England.ages.latest$age == "12_15")
...
vaccinations.12to15 <- vaccinations.12to15 %>% 
  rename(
    ...
    sum.secondDoseOnly = SecondDoseOnly,
    sum.thirdDose = cumPeopleVaccinatedThirdInjectionByVaccinationDate,
...
# 16 to 17
vaccinations.16to17 <- subset(vaccinations.England.ages.latest, vaccinations.England.ages.latest$age == "16_17")
...
# 18 to 29
vaccinations.18to29 <- subset(vaccinations.England.ages.latest, vaccinations.England.ages.latest$age == "18_24" | vaccinations.England.ages.latest$age == "25_29")
...
vaccinations.18to29 <- vaccinations.18to29 %>% 
  ...
  mutate(sum.thirdDose = sum(cumPeopleVaccinatedThirdInjectionByVaccinationDate)) %>%
  mutate(sum.firstDoseOnly = sum(FirstDoseOnly)) %>%
  mutate(sum.noVaccine = sum(NoVaccine)) %>%
  mutate(sum.secondDoseOnly = sum(SecondDoseOnly)) %>%
  slice(-1) %>%
  mutate_at("age", str_replace, "25_29", "18-29") %>%
  select(-c(4,5,6,7,8,9,10,11))

# 30 to 39
vaccinations.30to39 <- subset(vaccinations.England.ages.latest, vaccinations.England.ages.latest$age == "30_34" | vaccinations.England.ages.latest$age == "35_39")
...
# 40 to 49 
vaccinations.40to49 <- subset(vaccinations.England.ages.latest, vaccinations.England.ages.latest$age == "40_44" | vaccinations.England.ages.latest$age == "45_49")
...
# 50 to 59
vaccinations.50to59 <- subset(vaccinations.England.ages.latest, vaccinations.England.ages.latest$age == "50_54" | vaccinations.England.ages.latest$age == "55_59")
...
# 60 to 69
vaccinations.60to69 <- subset(vaccinations.England.ages.latest, vaccinations.England.ages.latest$age == "60_64" | vaccinations.England.ages.latest$age == "65_69")
...
# 70 to 79
vaccinations.70to79 <- subset(vaccinations.England.ages.latest, vaccinations.England.ages.latest$age == "70_74" | vaccinations.England.ages.latest$age == "75_79")
...
# 80 to 89
vaccinations.80to89 <- subset(vaccinations.England.ages.latest, vaccinations.England.ages.latest$age == "80_84" | vaccinations.England.ages.latest$age == "85_89")
...
# 90+
vaccinations.90 <- subset(vaccinations.England.ages.latest, vaccinations.England.ages.latest$age == "90+")
...
vaccinations.England.grouped$`Three doses`  <- vaccinations.England.grouped$sum.thirdDose / vaccinations.England.grouped$sum.vaccineRegister *100
vaccinations.England.grouped$`Two doses only` <- vaccinations.England.grouped$sum.secondDoseOnly / vaccinations.England.grouped$sum.vaccineRegister *100
